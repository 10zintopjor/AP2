...
const BoxComponent = () => {
  ...
  return (
    <div className="BoxComponent mx-auto p-6 md:p-3">
      <Carousel
        swipeable
        draggable
        ...
        autoPlay
        autoPlaySpeed={2000}
        partialVisbile={false} // Set to false to hide half cards
      >
        {servicesData.map((service, index) => (
          <div key={index} className="box p-6 text-center relative flex flex-col hover:bg-gray-100 shadow-md rounded-lg border border-solid border-gray-300 mx-2" style={{ minWidth: '200px', height: '400px' }}>
            ...
            <div className="title font-bold text-2xl mt-8 mb-4">{service.title}</div>
