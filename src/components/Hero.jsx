...
function Hero() {
  return (
    <div className='items-center'>
      ...
      <div className='flex bg-customBlue h-32 border-solid-gray-100 text-white items-center justify-center'>
        <div className='text-right mr-20 text-2xl'>
        <p>Proudly Serving GTA</p>
        </div>
        <VerticalLine />
        <div className='text-left ml-20 text-2xl'>
