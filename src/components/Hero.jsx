...
function Hero() {
  return (
    <div className='items-center'>
          <div className="relative flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat text-white h-full" style={{ backgroundImage: `url(${hero_img})`}}>
        <div className="absolute inset-0 bg-black opacity-50"></div> {/* Dark overlay */}
        <div className="z-10 p-6 text-center m-32 max-w-4xl">
          <h1 className="text-6xl font-bold">Reliable Plumbing Services in the GTA</h1>
