...
function Hero() {
  return (
    <>
    <div
      className="relative flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat text-white mt-10 md:mt-0"
      style={{ backgroundImage: `url(${hero_img})`, minHeight: 'calc(100vh - 64px)' }} // Set minimum height for the hero section
    >
      <div className="absolute inset-0 bg-black opacity-50"></div> {/* Dark overlay */}
      <div className="relative z-10 p-6 text-center max-w-4xl">
        <h1 className="text-6xl font-bold mt-20">Reliable Plumbing Services in the GTA</h1>
        <h3 className="text-2xl mt-8">We provide high-quality plumbing services for residential and commercial clients in the Greater Toronto Area</h3>
    ...
    <div className='flex flex-col md:flex-row sm:m-10 my-12 mx-2 items-center'>
      ...
      <div className='sm:p-10 p-2 md:w-1/2 w-full'>
        <img src={hero_img} alt="logo" className='w-full h-auto' /> {/* Ensuring the image is responsive */}
      </div>
    </div>
    </>
  );
